...
SYSTEM_PROMPT = "Você é um especialista em livros."
USER_PROMPT = "Me descreva em tópicos as lições principais do livro"
PDF_PATH = "A-ARTE-DA-GUERRA.pdf"
