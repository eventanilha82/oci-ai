...
SYSTEM_PROMPT = "Você é um especialista em imagens."
USER_PROMPT = "Me descreva de forma sucita imagem e me conte como essa imagem mudou o mundo do processamento de imagens"
BASE64_IMAGE = encode_file("LENNA.png")
